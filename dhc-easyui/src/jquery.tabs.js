...
//					selectTab(container, getLiIndex(li));
	...
	function createTab(container, options, pp) {
		...
		pp.panel($.extend({}, options, {
			...
			onLoad: function(){
				if (options.onLoad){
					options.onLoad.call(this, arguments,options);
				}
			...
			onOpen: function(){
				...
				state.options.onSelect.call(container, popts.title, getTabIndex(container, this), popts);
			},
			...
			onClose: function(){
				...
				var popts = $(this).panel('options');
				state.options.onUnselect.call(container, popts.title, getTabIndex(container, this), popts);
			}
		}));
	...
	function addTab(container, options) {
		...
		opts.onAdd.call(container, options.title, options.index,options);
		if (options.selected){
